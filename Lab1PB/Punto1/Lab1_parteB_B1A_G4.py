...
class Lab1_parteB_B1A_G4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab1_parteB_B1A_G4")
...
def main(top_block_cls=Lab1_parteB_B1A_G4, options=None):
