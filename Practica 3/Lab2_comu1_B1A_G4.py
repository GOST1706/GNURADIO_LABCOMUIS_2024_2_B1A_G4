...
class Lab2_comu1_B1A_G4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab2_comu1_B1A_G4")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fm, A, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_throttle2_0, 0))
    ...
    def set_A(self, A):
        self.A = A
        self.analog_sig_source_x_2.set_amplitude(self.A)




def main(top_block_cls=Lab2_comu1_B1A_G4, options=None):
