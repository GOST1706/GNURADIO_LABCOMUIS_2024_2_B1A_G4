...
class Jaiver_Buitrago_Juan_Quezada_B1A_G4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Jaiver_Buitrago_Juan_Quezada_B1A_G4")
...
def main(top_block_cls=Jaiver_Buitrago_Juan_Quezada_B1A_G4, options=None):
