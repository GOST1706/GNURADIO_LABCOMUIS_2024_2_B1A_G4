...
class Pra3B_comu1_B1A_G4_modulineal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Pra3B_comu1_B1A_G4_modulineal")
...
def main(top_block_cls=Pra3B_comu1_B1A_G4_modulineal, options=None):
